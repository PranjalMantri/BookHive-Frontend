...
//             <h2 className="text-3xl font-semibold mb-4 text-center">Add a Book</h2>
...
//                                 })}
//                             />
//                             <div className="text-red-500 text-sm mt-1 min-h-[0.25rem]">{errors.title?.message}</div>
//                         </div>

//                         <div>
//                             <label className="block text-md font-medium text-gray-700">Cover URL</label>
//                             <input
//                                 type="text"
//                                 placeholder="Cover URL"
//                                 className="mt-1 p-1 block w-full rounded-md border-2 border-gray-400 shadow-sm focus:outline-none focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
//                                 {...register("coverUrl", {
//                                     required: "Cover URL of the book is required",
//                                 })}
//                             />
//                             <div className="text-red-500 text-sm mt-1 min-h-[0.25rem]">{errors.coverUrl?.message}</div>
//                         </div>

//                         <div>
//                             <label className="block text-md font-medium text-gray-700">Current Page</label>
//                             <input
//                                 type="number"
//                                 placeholder="0"
//                                 className="mt-1 p-1 block w-full rounded-md border-2 border-gray-400 shadow-sm focus:outline-none focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
...
//                     <div>
//                         <div>
//                             <label className="block text-md font-medium text-gray-700">Author</label>
//                             <input
//                                 type="text"
//                                 placeholder="Author"
//                                 className="mt-1 p-1 block w-full rounded-md border-2 border-gray-400 shadow-sm focus:outline-none focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
...
//                                     minLength: {
//                                         value: 3,
//                                         message: "Author name should be longer than 3 characters",
//                                     },
//                                 })}
//                             />
//                             <div className="text-red-500 text-sm mt-1 min-h-[0.25rem]">{errors.author?.message}</div>
//                         </div>

//                         <div>
//                             <label className="block text-md font-medium text-gray-700">Total Pages</label>
//                             <input
//                                 type="number"
//                                 placeholder="0"
//                                 className="mt-1 p-1 block w-full rounded-md border-2 border-gray-400 shadow-sm focus:outline-none focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
...
//                             </select>
//                             <div className="text-red-500 text-sm mt-1 min-h-[0.25rem]">{errors.status?.message}</div>
//                         </div>
//                     </div>
//                 </div>
